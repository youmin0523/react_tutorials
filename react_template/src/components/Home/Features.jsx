  ...
  return (
    <div className='mt-20 border-b border-neutral-800'>
      <div className='text-center'>
        <span className='dark:bg-neutral-900 text-indigo-500 py-1 px-2 text-sm font-medium uppercase rounded-full light:border light: bg-neutral-500 border light:bg-white dark:border-0'>Features</span>
